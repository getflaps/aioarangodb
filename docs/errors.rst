...
All aioarangodb exceptions inherit :class:`aioarangodb.exceptions.ArangoError`,
which splits into subclasses :class:`aioarangodb.exceptions.ArangoServerError` and
:class:`aioarangodb.exceptions.ArangoClientError`.

Server Errors
=============

:class:`aioarangodb.exceptions.ArangoServerError` exceptions lightly wrap non-2xx
...
:class:`aioarangodb.exceptions.ArangoClientError` exceptions originate from
...
.. automodule:: aioarangodb.exceptions
    :members:
